...
// filterEl.innerHTML = "<h1>Manufacturing Businesses</h1>"

// Array to contain all the Manufacturing businesses
// const manufacturingBusinesses = businesses.filter(business => {
//     let inManufacture = false
  
//     if (business.companyIndustry === "Manufacturing") {
//         inManufacture = true
//     }
  
//     return inManufacture;
...
/* Create a factory function that creates an object [createNewAgent] with the attributes of "fullName", "company", and "phoneNumber" that pull the respective data from the [businesses] array. */
...
/* The forEach loop takes the objects [createNewAgent] created within the [agents] variable and posts them to the DOM in their respective tags. */    
...
/* Create an object that runs the filter() array method that runs the find() array method inside of it to return businesses with orders over $9000.00 */
